...
<div style="width: 80%;margin:50px auto">
    <ul>
        ...
        <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li><a href="<?php echo e($v->id); ?>.html" title="<?php echo e(str_replace('》','',str_replace('《','',$v->author))); ?>" ><?php echo e(str_replace('》','',str_replace('《','',$v->author))); ?></a></li>
...
<?php /**PATH /home/wwwroot/1984/resources/views/index/map.blade.php ENDPATH**/ ?>